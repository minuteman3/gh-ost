...
func main() {
	...
	flag.BoolVar(&migrationContext.SkipTableTriggersCheck, "skip-table-triggers-check", false, "set to 'true' when you know for certain there are no triggers on your table, and wish to skip the time it takes for gh-ost to verify that")
